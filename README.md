...
```groovy
plugins {
    id 'com.github.jk1.dependency-license-report' version '3.1.4'  // x-release-please-version
}
```
...
dependencies {
    implementation 'com.github.jk1:gradle-license-report:3.1.4'  // x-release-please-version
}
```
