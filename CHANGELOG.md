...
* build(deps): bump com.diffplug.spotless from 8.4.0 to 8.6.0 by @dependabot[bot] in https://github.com/jk1/Gradle-License-Report/pull/400
* build(deps): bump com.gradle.develocity from 4.4.1 to 4.4.2 by @dependabot[bot] in https://github.com/jk1/Gradle-License-Report/pull/399
* fix: improve mappings for GNU classpath exception & MPL URLs with trailing slash by @chadlwilson in https://github.com/jk1/Gradle-License-Report/pull/402
* fix: support multiple license URLs from OSGi manifest data by @chadlwilson in https://github.com/jk1/Gradle-License-Report/pull/401
